...
import { Check, ShieldCheck, Lock, Clock, Phone, Mail, LogOut } from 'lucide-react'
...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      {isCancelled && (
        <div className="bg-amber-50 border-b border-amber-200 py-3 px-6 text-center text-amber-800 text-sm font-medium">
          Payment cancelled. Please choose a plan to continue setting up your store.
        </div>
      )}
        ...
        <aside className="hidden lg:flex w-1/3 max-w-sm bg-white border-r p-12 flex-col space-y-12">
          <div className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              Complete these final steps to activate your MedPOS dashboard for <strong>{user?.user_metadata?.store_name || "your store"}</strong>.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-12">
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      plan.is_popular ? "border-primary ring-1 ring-primary shadow-xl scale-105 z-10" : "border-slate-200"
                    )}
                  >
                    {plan.is_popular && (
                    ...
                    <CheckoutButton
                      ...
                      className={cn(
                        ...
                        plan.is_popular ? "bg-primary text-white" : "border-primary text-primary hover:bg-primary/5"
                      )}
            ...
            <div className="pt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center max-w-4xl mx-auto border-t border-slate-100">
              <div className="space-y-2">
                ...
                <p className="text-xs font-bold text-primary uppercase tracking-widest">Safepay Secure</p>
                <p className="text-[10px] text-muted-foreground">Regulated by State Bank of Pakistan</p>
              </div>
              <div className="space-y-2">
                <div className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-2 text-slate-600">
